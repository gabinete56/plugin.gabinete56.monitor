...
cache_path = xbmcaddon.Addon().getAddonInfo('profile') + 'cache.json'
...
if not os.path.exists(cache_path) or DEBUG==True:
  ...
  for cat in CATEGORIES:
    cache['c'+str(cat[0])] = scraper.scrape(cat)
...
def list_categories():
    ...
    for category in categories:
        ...
        list_item = xbmcgui.ListItem(label=VIDEOS[category][0]['genre'])
        ...
        list_item.setInfo('video', {'title': category, 'genre': category, 'mediatype' : 'tvshows'})
